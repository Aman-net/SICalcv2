...
export default function App() {
    ...
    return (
        <div className="h-full flex flex-col bg-slate-50 max-w-lg mx-auto relative">
            {/* ── Header ── */}
            <header className="shrink-0 bg-gradient-to-r from-indigo-600 to-violet-600 text-white px-4 py-2.5 flex items-center justify-between">
                <h1 className="text-lg font-black tracking-tight leading-none">
                    SI Calc
                </h1>
                <button
                    onClick={openSettings}
                    className="w-9 h-9 flex items-center justify-center rounded-full bg-white/15 hover:bg-white/25 active:scale-90 transition-all text-lg"
                    aria-label="Settings"
                >
                    ⚙️
                </button>
